...
public class ParkingLot extends HttpServlet {
    ...
    private void selectState(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("all".equals(state)) {
            ...
            try {
                List<ParkingSpace> list = service.findByState(state);
